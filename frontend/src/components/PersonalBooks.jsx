...
export function PersonalBooks() {
  ...
  // Helper function to refresh the global liked and saved books
  const refreshUserBooks = async () => {
    ...
    try {
      ...
      if (favoritesRes.ok && toReadRes.ok) {
        ...
        // Assuming the API returns arrays directly.
        setLikedBooks(favoritesData);
        setSavedBooks(toReadData);
      }
    } catch (error) {
  ...
  const handleRemoveBook = async (bookId) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Refresh global state after removal
  ...
  const handleLike = async (book) => {
    ...
    try {
      ...
      // Refresh global state after updating favorites
      await refreshUserBooks();
    } catch (error) {
  ...
  const handleSave = async (book) => {
    ...
    try {
      ...
      // Refresh global state after updating saved books
      await refreshUserBooks();
    } catch (error) {
